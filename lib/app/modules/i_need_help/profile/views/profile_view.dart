...
class ProfileView extends GetView<ProfileController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // SingleChildScrollView একাই পুরো পেজ স্ক্রল করবে
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // Menu Items Section (Removed Expanded and ListView to fix layout crash)
            _buildMenuItem(
              icon: AppImages.user,
            ...
            _buildMenuItem(
              ...
              title: 'My Reviews',
              onTap: () => Get.to(() => const ClientReviewsView()),
            ),
            const Divider(height: 1, color: Color(0xFFF0F0F0)),
