...
class WorkerSupportTicketView extends StatelessWidget {
  const WorkerSupportTicketView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(WorkerSupportTicketController());
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            InkWell(
              onTap: () => _showJobSelectionSheet(context, controller),
              borderRadius: BorderRadius.circular(8),
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Obx(() {
                      final isSelected = controller.selectedJob.value.isNotEmpty;
                      return Text(
                        isSelected ? controller.selectedJob.value : AppStrings.selectYourOrder.tr,
                        style: TextStyle(
                    ...
                    const Icon(Icons.keyboard_arrow_down, color: Color(0xFF9E9E9E), size: 20),
                  ],
                ),
              ),
            ),
                  ...
                  children: [
                    Obx(() {
                      ...
                      return Text(
                        ...
                        style: TextStyle(
                          color: isAttached ? Colors.black : const Color(0xFF9E9E9E),
                          fontSize: 14,
                        ),
                      );
                    }),
                    Obx(() {
                      ...
                      return Icon(
                        ...
                        color: isAttached ? const Color(0xFF32C759) : const Color(0xFF9E9E9E),
                        size: 20,
                      );
                    }),
                  ],
              ...
              GestureDetector(
                ...
                child: Obx(() {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                        color: controller.isTermsAccepted.value ? const Color(0xFF32C759) : const Color(0xFFE5E5E5),
                        width: 1.5,
                      ),
                      borderRadius: BorderRadius.circular(4),
                      color: controller.isTermsAccepted.value ? const Color(0xFF32C759) : Colors.transparent,
                    ),
  ...
  void _showJobSelectionSheet(BuildContext context, WorkerSupportTicketController controller) {
    Get.bottomSheet(
      Container(
